  ...
  en: {
    ...
    p3: {
      ...
      stack: [
        ...
        "Architecture: Component-Based Modular System, State Manager (GameManager), Coroutines",
        "Core Gameplay: Procedural Spawning Algorithms & Conditional Combo Logic",
        "UI/UX: Unity UI, TextMeshPro, Canvas Scaler (Responsive), Dynamic Anchoring",
